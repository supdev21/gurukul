...
class Educrat_Elementor_Learnpress_Category_Banner extends Widget_Base {

	public function get_name() {
        return 'apus_category_banner';
    }

	public function get_title() {
        return esc_html__( 'Apus LearnPress Category Banner', 'educrat' );
    }
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Educrat_Elementor_Learnpress_Category_Banner );
} else {
    Plugin::instance()->widgets_manager->register( new Educrat_Elementor_Learnpress_Category_Banner );
}