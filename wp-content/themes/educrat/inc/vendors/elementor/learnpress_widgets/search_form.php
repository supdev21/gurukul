...
class Educrat_Elementor_Search_Form extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_course_search_form';
    }

	public function get_title() {
        return esc_html__( 'Apus Learnpress Course Search Form', 'educrat' );
    }
	...
	protected function render() {
        ...
        <div class="apus-search-form-course <?php echo esc_attr($el_class.' '.$layout_type); ?>">
            ...
            <?php } ?>
            <form action="<?php echo esc_url( learn_press_get_page_link( 'courses' ) ); ?>" method="get" class="search-form-popup">
                <div class="form-inner">
                    <div class="search-form-course <?php echo esc_attr($layout_type); ?>">
                        <div class="d-sm-flex align-items-center">
                            <input type="text" placeholder="<?php echo esc_attr( $placeholder ); ?>" name="c_search" class="form-control" autocomplete="off"/>
                            ...
                            <button type="submit" class="btn btn-theme btn-search ms-auto">
                                ...
                                if ( $btn_text ) {
                                    echo '<span class="text-search">'.esc_html($btn_text).'</span>';
                                }
                                ?>
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Educrat_Elementor_Search_Form );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Educrat_Elementor_Search_Form );
}