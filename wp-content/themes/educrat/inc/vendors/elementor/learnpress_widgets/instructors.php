...
class Educrat_Elementor_Learnpress_Instructors extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_learnpress_instructors';
    }

	public function get_title() {
        return esc_html__( 'Apus Learnpress Instructors', 'educrat' );
    }
	...
	protected function render() {
        ...
        $instructors = educrat_course_get_instructors( $limit );
        ?>
                        ...
                        <div class="slick-carousel <?php echo ( ( $columns >= count($instructors) )? 'hidden-dots' : '' ); ?>"
                            ...
                            foreach ( $instructors as $instructor ) {
                                if($item_style == 'style1'){
                                    learn_press_get_template( 'content-instructor', array('instructor' => $instructor) );
                                } elseif($item_style == 'style2') {
                                    learn_press_get_template( 'content-instructor-v2', array('instructor' => $instructor) );
                                }
                            }
                            ?>
                        </div>
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Educrat_Elementor_Learnpress_Instructors );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Educrat_Elementor_Learnpress_Instructors );
}