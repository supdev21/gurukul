...
class Educrat_Elementor_Learnpress_Categories_Banner extends Widget_Base {

	public function get_name() {
        return 'apus_categories_banner';
    }

	public function get_title() {
        return esc_html__( 'Apus LearnPress Categories Banner', 'educrat' );
    }
        ...
        if ( $categories ) {
            ...
            <?php
                foreach ($categories as $item) {
                    ...
                    $term = get_term_by( 'slug', $item['slug'], 'course_category' );
                    ...
                    if ($term) {
                        if ( empty($link) ) {
                            $link = get_term_link( $term, 'course_category' );
                        }
                        if ( empty($title) ) {
                            $title = $term->name;
                        }
                    ...
                    <div class="widget-category-banner">
                        ...
                        <?php } ?>
                            <div class="inner">
                                <div class="banner-content-wrapper d-flex flex-column <?php echo esc_attr($style); ?>" <?php echo trim($style_bg); ?>>
                                    <?php if($style !== 'style2') { ?>
                                        <?php
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Educrat_Elementor_Learnpress_Categories_Banner );
} else {
    Plugin::instance()->widgets_manager->register( new Educrat_Elementor_Learnpress_Categories_Banner );
}