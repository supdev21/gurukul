...
class Educrat_Elementor_Tutor_Courses_Tabs extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_tutor_courses_tabs';
    }

	public function get_title() {
        return esc_html__( 'Apus Tutor Courses Tabs', 'educrat' );
    }
                    ...
                    <div class="tab-content">
                        <?php $i = 0; foreach ($tabs as $tab) : ?>
                            <div id="tab-<?php echo esc_attr($_id);?>-<?php echo esc_attr($i); ?>" class="tab-pane fade <?php echo esc_attr($i == 0 ? 'show active' : ''); ?>">
                                ...
                                <?php
                                    $category_ids = !empty($tab['category_ids']) ? array_map('trim', explode(',', $tab['category_ids'])) : array();
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Educrat_Elementor_Tutor_Courses_Tabs );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Educrat_Elementor_Tutor_Courses_Tabs );
}