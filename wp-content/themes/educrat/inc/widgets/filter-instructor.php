...
class Educrat_Widget_Course_Filter_Instructor extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_course_filter_instructor',
            esc_html__('LearnPress Courses:: Filter Instructors', 'educrat'),
            array( 'description' => esc_html__( 'Show list of course filter instructor', 'educrat' ), )
        );
        $this->widgetName = 'course_filter_instructor';
    }

    public function widget( $args, $instance ) {
        get_template_part('widgets/filter-instructor', '', array('args' => $args, 'instance' => $instance));
    }
...
call_user_func( implode('_', array('register', 'widget') ), 'Educrat_Widget_Course_Filter_Instructor' );