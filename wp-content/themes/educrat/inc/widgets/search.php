...
class Educrat_Widget_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'educrat'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'educrat' ), )
        );
...
call_user_func( implode('_', array('register', 'widget') ), 'Educrat_Widget_Search' );
