...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="the-comment">
		...
		<div class="comment-box">
			...
			<div class="mt-1">
				<div id="comment-reply-wrapper-<?php comment_ID(); ?>" class="comment-author replylink">
					<?php comment_reply_link(array_merge( $args, array(
						'reply_text' => '<i class="ti-back-left"></i>'.esc_html__('Replyddddd', 'educrat'),
			...
			<!-- <div class="ms-auto">
				<div class="comment-author">
					...
					<?php 
						...
						'reply_text' => '<span class="text-reply"><i class="ti-back-left"></i>'.esc_html__('Reply', 'educrat').'</span>', 
						'add_below' => 'comment', 
						'depth' => $depth, 
						'max_depth' => $args['max_depth']
						))) 
