	...
	<div id="review_form_wrapper" class="commentform box-info-white">
		...
		<div class="reply_comment_form hidden">
			<?php
				$comment_form = array(
					...
					'label_submit'  => esc_html__( 'Submit Reply', 'educrat' ),
					'logged_in_as'  => '',
					'comment_field' => '',
		...
		<div id="review_form">
			<?php
				...
				$comment_form['comment_field'] .= '<div class="form-group"><label>'.esc_attr__('Reviews', 'educrat').'</label><textarea id="comment" class="form-control" placeholder="'.esc_attr__( 'Write Reviews', 'educrat' ).'" name="comment" cols="45" rows="10" aria-required="true"></textarea></div>';
