                        ...
                        <div class="course-meta-bottom">
                            ...
                            <div class="d-inline-block">
                                <?php
                                    ...
                                    echo '<a href="javascript:;" class="'. esc_attr( $action_class ) .' save-bookmark-btn" data-course-id="'. esc_attr( $course_id ) .'">
                                        <i class="' . ( $is_wish_listed ? 'tutor-icon-bookmark-bold' : 'tutor-icon-bookmark-line') . '"></i><span class="wishlist-text">'.esc_html__('Wishlist','educrat').'</span>
                                    </a>';
                                ?>
                            </div>
                        </div>
