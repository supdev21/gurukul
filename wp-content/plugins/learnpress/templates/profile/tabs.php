...
echo $checkUser = $currentUser->roles[0];
...
<!----   subscriber || administrator ||    ---->
	...
	<ul class="lp-profile-nav-tabs">
		...
		<?php if( $checkUser === 'lp_teacher'){ ?>
			<!-- <li class="logout">
				<a href="http://localhost/defguru/lp-profile/Abhijit/export-orders/" data-slug="http://localhost/defguru/lp-profile/Abhijit/export-orders/">
					<i class="fas fa-sign-out-alt"></i>Export Orders Data</a>
